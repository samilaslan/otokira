<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMusteri.aspx.cs" Inherits="frmMusteri" %>
                ...
                <tbody>
                    <tr>
                        <td style="width: 400px;">
                            ...
                            <telerik:RadButton ID="chkOnayYonetici" runat="server" AutoPostBack="false"
                                ...
                                <ToggleStates>
                                    ...
                                    <telerik:RadButtonToggleState ImageUrl="~/images/imgCheck24n.png" IsBackgroundImage="true" />
                                          ...
                                          <td style="width: 80%;">Yönetici Yetkisi veriyorum.
                        ...
                        <td style="width: 300px;">
                            <table style="width: 300px;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <telerik:RadGrid ID="rgResimler" runat="server" Height="200px" Width="100%" AllowSorting="true" OnItemCommand="rgResimler_ItemCommand" AutoGenerateColumns="False" Skin="Bootstrap" AllowFilteringByColumn="false" PageSize="25" AllowPaging="false" OnNeedDataSource="rgResimler_NeedDataSource" Culture="tr-TR" OnSelectedIndexChanged="rgResimler_SelectedIndexChanged">
            ...
            <telerik:RadGrid ID="rdGridListe" runat="server" AllowFilteringByColumn="true" Width="100%" Height="300px" AllowPaging="True" PagerStyle-PageSizeControlType="None" AllowCustomPaging="true" PagerStyle-PageSizes="50" AllowSorting="true"
                ...
                <MasterTableView AutoGenerateColumns="False" DataKeyNames="MUSTERI_ID,TC,Ad,Soyad,ADRES,YETKI,MAIL,EHLIYETNO,Tel">
                    <Columns>
                        ...
                        <telerik:GridButtonColumn ButtonType="ImageButton" HeaderText="Sil" CommandName="btnSil" ConfirmDialogType="RadWindow" ConfirmText="Müşteri Kaydını Silmek İstiyormusunuz..." ConfirmDialogHeight="135px" ConfirmDialogWidth="350px" ConfirmTitle="... Dikkat ..."
                            UniqueName="colSil" ImageUrl="~/Images/ImgDelete.png">
                            <HeaderStyle HorizontalAlign="Center" Width="45px" Font-Bold="true" />
                            <ItemStyle HorizontalAlign="Center" />
                        </telerik:GridButtonColumn>
